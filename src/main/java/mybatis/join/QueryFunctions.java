...
public class QueryFunctions {
    ...
    public static QueryCondition exist(JoinQueryWrapper queryWrapper) {
        return new OperatorSelectCondition(" EXIST ", queryWrapper);
    }

    public static QueryCondition notExist(JoinQueryWrapper queryWrapper) {
    ...
    private static JoinQueryWrapper newWrapper() {
        return new JoinQueryWrapper();
    }

    public static JoinQueryWrapper select(QueryColumn... queryColumns) {
        return newWrapper().select(queryColumns);
    }

    public static JoinQueryWrapper selectOne() {
