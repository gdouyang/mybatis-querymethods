 ...
 */
package mybatis.querymethods.spring.data.query.domain;
 ...
 */
public class Sort implements Iterable<mybatis.querymethods.spring.data.query.domain.Sort.Order>, Serializable {
