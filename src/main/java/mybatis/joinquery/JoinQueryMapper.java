...
public interface JoinQueryMapper<T> {
     ...
     * @return 数据列表
     * @see mybatis.joinquery.JoinQuerySqlProvider#selectListByQuery(Map, ProviderContext)
     */
     ...
     * @param queryWrapper
     * @return 数据量
     * @see mybatis.joinquery.JoinQuerySqlProvider#selectCountByQuery(Map, ProviderContext)
     */
