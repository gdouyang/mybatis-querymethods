...
public class MybatisPlusQueryEntityProcesser extends AbstractQueryEntityProcesser {
	...
	public String getTableName(Element t) {
    	Map<String, AnnotationValue> defaultValues = getAnnotationDefaultValues(t, "com.baomidou.mybatisplus.annotation.TableName");
	...
	public String getColumnName(Element t) {
		Map<String, AnnotationValue> defaultValues = getAnnotationDefaultValues(t, "com.baomidou.mybatisplus.annotation.TableField");
