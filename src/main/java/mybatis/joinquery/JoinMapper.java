...
public interface JoinMapper<T> {
     ...
     * @return 数据列表
     * @see mybatis.joinquery.JoinSqlProvider#selectListByQuery(Map, ProviderContext)
     */
     ...
     * @param queryWrapper
     * @return 数据量
     * @see mybatis.joinquery.JoinSqlProvider#selectCountByQuery(Map, ProviderContext)
     */
